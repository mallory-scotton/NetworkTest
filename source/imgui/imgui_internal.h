...
struct ImGuiContext
{
    ...
    //bool                  NavDisableHighlight;                // Old name for !g.NavCursorVisible before 1.91.4 (2025/10/18). OPPOSITE VALUE (g.NavDisableHighlight == !g.NavCursorVisible)
    //bool                  NavDisableMouseHover;               // Old name for g.NavHighlightItemUnderNav before 1.91.1 (2025/10/18) this was called When user starts using keyboard/gamepad, we hide mouse hovering highlight until mouse is touched again.
...
struct IMGUI_API ImGuiWindow
{
    ...
    float                   TitleBarHeight, MenuBarHeight;      // Note that those used to be function before 2025/05/28. If you have old code calling TitleBarHeight() you can change it to TitleBarHeight.
